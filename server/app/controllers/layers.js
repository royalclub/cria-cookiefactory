...
exports.updateOne = function (req, res) {
    ...
    var conditions =
        ...
        update = {
            ...
            layerIngredients: req.body.layerIngredients || '',
            layerOrder: req.body.layerOrder || '',
            layerDescription: req.body.layerDescription || '',
            layerPrice: req.body.layerPrice || '',
            layerImageSrc: req.body.layerImageSrc || '',
            layerModificationDate: new Date()
        },
        options = {multi: false},
